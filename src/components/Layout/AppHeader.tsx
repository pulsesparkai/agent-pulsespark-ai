...
export const AppHeader: React.FC<AppHeaderProps> = ({ 
  ...
  return (
    <>
      ...
      <header className={`
        fixed top-0 left-0 right-0 z-50 h-16 bg-white shadow-md border-b border-gray-200
        ${className}
      `}>
        <div className="flex items-center justify-between px-6 h-full max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            {onMenuClick && (
              <button
                onClick={onMenuClick}
                className="p-2 text-gray-400 hover:text-gray-600 lg:hidden transition-colors rounded-md hover:bg-gray-100"
            ...
            <button
              ...
              className="
                rounded-full w-10 h-10 bg-gradient-to-br from-green-600 to-green-700
            ...
            <form onSubmit={handleSearchSubmit} className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  className="
                    block w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-2 text-gray-400 hover:text-gray-600 md:hidden transition-colors rounded-md hover:bg-gray-100"
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              <button
                ...
                className="
                  flex items-center gap-2 p-1 rounded-full hover:bg-gray-100 
                ...
                ">
                  ...
                  <button
                    ...
                    className="
                      ...
                      hover:bg-green-50 hover:text-green-700 transition-colors text-left
                    "
                  >
                  ...
                  <button
                    ...
                    className="
                      ...
                      hover:bg-red-50 hover:text-red-700 transition-colors text-left
                    "
                  >
      ...
      {showMobileSearch && (
        <div 
          ref={mobileSearchRef}
          className="
            fixed top-16 left-0 right-0 z-40 bg-white border-b border-gray-200 
            shadow-md md:hidden
          "
        >
            ...
            <form onSubmit={handleSearchSubmit} className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="
                    block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-md
                    text-gray-900 placeholder-gray-500 bg-white
                    focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent
                  "
                  placeholder="Search projects, chats..."
